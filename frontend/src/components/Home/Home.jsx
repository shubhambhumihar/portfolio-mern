...
import venusImage from "../../images/neptune.png";
// import spaceImage from "../../images/spacee.png";
import spaceImage from "../../images/f.jpg";
    ...
    <div>
      ...
      <div className="homeCanvasContainer">
        ...
        <div className="homeCanvasBox">
          ...
          <Typography variant="h2">BLOOGER</Typography>
        </div>
      ...
      <div className="homeYoutube">
        ...
        <div className="homeYoutubeWrapper">
          ...
          {/* <YoutubeCard
            image={
              "https://i.pinimg.com/474x/29/98/44/2998444ec4f5ec2eeb13d54ece04010f.jpg"
            }
            title={"Sample video"}
            // url={item.url}
            // id={item._id}
